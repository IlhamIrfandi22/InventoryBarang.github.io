    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><center><img src="../logo1.png" alt="logo" width="80%"></center></a>
            </div>
            <div class="main-menu">
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="keluar.php">Barang Keluar / Digunakan</a></li>
                                </ul>
                            </li>
                            <li>
